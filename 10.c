/*Assignment no: 10
Title: Write a program to create a student database. Database contains 
different fields of students like Roll No, Name, and percentage. 
Search for a particular student according to roll number using binary search.
Code:*/
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
